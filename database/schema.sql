...
--
-- Host: localhost    Database: transcosmos_fullstack
-- ------------------------------------------------------
...
CREATE TABLE `file_versions` (
  ...
  PRIMARY KEY (`id`),
  KEY `file_versions_attachment_id_index` (`attachment_id`),
  CONSTRAINT `file_versions_attachment_id_foreign` FOREIGN KEY (`attachment_id`) REFERENCES `task_attachments` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-05-27 16:46:00
